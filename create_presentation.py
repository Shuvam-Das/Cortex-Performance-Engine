...
slides_content = [
    ...
    },
    {
        ...
        "diagram_elements": [
            # --- Groups ---
            {"text": "Presentation Tier", "x": 0.5, "y": 2, "w": 15, "h": 2.5, "is_group": True, "font_size": 14, "color": COLOR_TARGET_ZONE},
            {"text": "Application Tier", "x": 0.5, "y": 4.75, "w": 15, "h": 2, "is_group": True, "font_size": 14, "color": COLOR_TARGET_ZONE},
            {"text": "Data Tier", "x": 0.5, "y": 7, "w": 15, "h": 1.5, "is_group": True, "font_size": 14, "color": COLOR_TARGET_ZONE},
            # Components
            ...
            # Arrows
            {"text": "HTTPS Request", "x": 2.5, "y": 2.5, "w": 2, "h": 0.5, "font_size": 11, "no_box": True, "color": COLOR_ARROW},
            {"text": "Serves Frontend", "x": 6.5, "y": 2.5, "w": 2, "h": 0.5, "font_size": 11, "no_box": True, "color": COLOR_ARROW},
            {"text": "API Calls (e.g., /api/products)", "x": 5, "y": 4.25, "w": 3, "h": 0.5, "font_size": 11, "no_box": True, "color": COLOR_ARROW},
            {"text": "Invokes", "x": 6.5, "y": 6.4, "w": 2, "h": 0.5, "font_size": 11, "no_box": True, "color": COLOR_ARROW},
            {"text": "Reads/Writes Data", "x": 9, "y": 6.75, "w": 2, "h": 0.5, "font_size": 11, "no_box": True, "color": COLOR_ARROW},
        ],
    ...
    },
    {
        ...
        "diagram_elements": [
            # --- Groups ---
            {"text": "Interaction Layer", "x": 0.5, "y": 2, "w": 15, "h": 1.75, "is_group": True, "font_size": 14, "color": COLOR_CORTEX_ZONE},
            {"text": "Orchestration Layer", "x": 0.5, "y": 4, "w": 15, "h": 1.75, "is_group": True, "font_size": 14, "color": COLOR_CORTEX_ZONE},
            {"text": "Agentic Core (Execution Layer)", "x": 0.5, "y": 6, "w": 15, "h": 2.5, "is_group": True, "font_size": 14, "color": COLOR_CORTEX_ZONE},
            # Components
            {"text": "User", "x": 1, "y": 2.5, "w": 2, "h": 1, "color": COLOR_INTERACTION},
            {"text": "AWS Lex\n(Chatbot)", "x": 4, "y": 2.5, "w": 3, "h": 1},
            {"text": "Trigger Lambda", "x": 8, "y": 2.5, "w": 3, "h": 1},
            ...
            # Arrows
            {"text": "Natural Language", "x": 2.5, "y": 2, "w": 2, "h": 0.5, "font_size": 11, "no_box": True, "color": COLOR_ARROW},
            {"text": "Parses Intent", "x": 6.5, "y": 2, "w": 2, "h": 0.5, "font_size": 11, "no_box": True, "color": COLOR_ARROW},
            {"text": "Starts Workflow", "x": 7.5, "y": 3.6, "w": 2, "h": 0.5, "font_size": 11, "no_box": True, "color": COLOR_ARROW},
            {"text": "Orchestrates Agents in Sequence", "x": 7.5, "y": 5.6, "w": 3, "h": 0.5, "font_size": 11, "no_box": True, "color": COLOR_ARROW},
        ],
    ...
    },
    {
        ...
        "diagram_elements": [
            ...
            {"text": "Shared Services & Data Flow", "x": 0.5, "y": 8.25, "w": 15, "h": 0.5, "is_group": True, "font_size": 14, "color": COLOR_SHARED_ZONE},
            # --- Cortex Zone ---
            {"text": "User", "x": 1, "y": 2, "w": 1.5, "h": 0.75, "color": COLOR_INTERACTION},
            {"text": "1. 'Run a test...'", "x": 2.5, "y": 2.15, "w": 1.5, "h": 0.5, "font_size": 11, "no_box": True, "color": COLOR_ARROW},
            {"text": "AWS Lex", "x": 4, "y": 2, "w": 1.5, "h": 0.75, "color": COLOR_INTERACTION},
            {"text": "Step Functions", "x": 1, "y": 4.5, "w": 3, "h": 1.5},
            {"text": "Agent Core", "x": 4.5, "y": 4, "w": 3, "h": 3.5},
            # --- Target Zone ---
            {"text": "API Gateway", "x": 8.75, "y": 3.5, "w": 2.5, "h": 1},
            {"text": "Lambda Backend", "x": 12.25, "y": 3.5, "w": 2.75, "h": 1},
            # --- Shared Zone ---
            {"text": "S3 Artifacts Bucket", "x": 1, "y": 8.25, "w": 6.5, "h": 0.5},
            {"text": "CloudWatch Logs", "x": 8.5, "y": 8.25, "w": 6.5, "h": 0.5},
            # --- Arrows ---
            {"text": "2. Starts Workflow", "x": 2, "y": 3.5, "w": 2, "h": 0.5, "font_size": 11, "no_box": True, "color": COLOR_ARROW},
            {"text": "3. Reads Logs", "x": 7.5, "y": 7.25, "w": 2, "h": 0.5, "font_size": 11, "no_box": True, "color": COLOR_ARROW},
            {"text": "4. Writes/Reads Scripts & Reports", "x": 1, "y": 7.25, "w": 3.5, "h": 0.5, "font_size": 11, "no_box": True, "color": COLOR_ARROW},
            {"text": "5. APPLIES LOAD", "x": 7.5, "y": 2.5, "w": 2, "h": 0.5, "font_size": 12, "no_box": True, "color": RGBColor(255, 0, 0), "bold": True},
        ],
        ...
        if slide_data.get("is_diagram"):
            for element in slide_data.get("diagram_elements", []):
                ...
                if element.get("is_group"):
                    ...
                    p.font.bold = True
                    shape.fill.solid()
                    shape.fill.fore_color.rgb = element.get("color", COLOR_CORTEX_ZONE)
