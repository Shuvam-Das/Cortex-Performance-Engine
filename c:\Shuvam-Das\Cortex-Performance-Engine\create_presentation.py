...
slides_content = [
    ...
    },
    {
        ...
        "points": [
            ...
            "The Solution: Introducing the Cortex Performance Engine",
    ...
    },
    {
        ...
        "subtitle": "A cloud-native, AI-driven platform that automates the resilience engineering lifecycle.",
        "points": [
...
def create_presentation(filename="Cortex_Performance_Engine_Presentation.pptx"):
    """
